...
public class Timing extends ListenerAdapter  {
    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent event){
        ...
        if  ( arg.length == 2 && (arg[0] + arg[1]).equalsIgnoreCase(Bot.prefix + "s") ) {
        ...
        else if ( arg.length == 4 && (arg[0] + arg[1]).equalsIgnoreCase(Bot.prefix + "-t")  ) {
            ...
            Timer timer = new Timer((Integer.parseInt(String.valueOf(arg[2].substring(1))) * 60000 ) + (( Integer.parseInt(String.valueOf(arg[3].substring(1))) -1 ) * 1000), taskPerformer);
