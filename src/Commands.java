...
public class Commands extends ListenerAdapter {
    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent event) {
        ...
        if (arg.length > 1 &&  (arg[0] + arg[1]).equalsIgnoreCase(Bot.prefix + "help") ) {
            ...
            info.addField(":c scramble -(<No. of Moves>) -(s/d)", "Gets you a scramble of requested length. -y --> executes the scramble, -d --> doesn't scramble your Cube", false) ;
            ...
            info.setImage("https://cdn.discordapp.com/attachments/812010624301269012/853061376351404049/Untitled_design_3.png");
